...
NL = {
    ...
    "imports.csv_tutorial_intro": "Haal je rekeningoverzicht bij DEGIRO op en laad het hier in één keer in. Je brokeractiviteiten worden dan verwerkt zonder handmatige invoer.",
    ...
    "imports.no_broker_accounts_warning": "⚠ Er is nog geen brokeraccount aangemaakt.",
    "imports.account_csv_broker_only": "Account.csv kan alleen bij een brokeraccount worden geïmporteerd.",
    ...
    "imports.account_add_link": "of voeg een nieuwe toe",
...
EN = {
    ...
    "imports.csv_tutorial_intro": "Download your DEGIRO account statement and load it here in one go. Your broker activity is then processed without manual entry.",
    ...
    "imports.no_broker_accounts_warning": "⚠ No broker account has been created yet.",
    "imports.account_csv_broker_only": "Account.csv can only be imported into a broker account.",
    ...
    "imports.account_add_link": "or add a new one",

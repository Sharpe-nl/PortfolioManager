...
NL = {
    ...
    "auth.register_heading": "Eerste installatie",
    "auth.yubikey_setup_heading": "Inloggen met YubiKey",
    ...
    "auth.setup_token_help": "Gebruik de eenmalige code uit de serverlog.",
    ...
    "auth.show_password_login": "Of inloggen met gebruikersnaam en wachtwoord",
    "auth.show_yubikey_login": "Terug naar inloggen met YubiKey",
...
EN = {
    ...
    "auth.register_heading": "Initial setup",
    "auth.yubikey_setup_heading": "Sign in with YubiKey",
    "auth.register_instructions_line1": "Register your YubiKey for access to the application.",
    "auth.setup_token_label": "Setup token",
    "auth.setup_token_help": "Use the one-time code from the server log.",
    ...
    "auth.show_password_login": "Or sign in with username and password",
    "auth.show_yubikey_login": "Back to YubiKey sign-in",

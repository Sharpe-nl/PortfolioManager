...
NL = {
    ...
    "settings.restore_hint": "Alleen beschikbaar in een lege installatie. Gebruik een databaseback-up van dezelfde appversie. Inloggegevens en gekoppelde API-sleutels worden niet meegenomen.",
...
EN = {
    ...
    "settings.restore_hint": "Available only for an empty installation. Use a database backup from the same app version. Login credentials and connected API keys are not included.",

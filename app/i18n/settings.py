...
NL = {
    ...
    "settings.btn_manage": "Beheren",
    "settings.section_password_login": "Gebruikersnaam & wachtwoord",
    "settings.password_intro": "Optionele lokale inlogmethode voor wie geen YubiKey of passkey gebruikt.",
    "settings.password_add": "Gebruiker toevoegen",
    "settings.password_change": "Wachtwoord wijzigen",
    "settings.confirm_delete_password_user": "Deze gebruiker verwijderen? Die kan dan niet meer met een wachtwoord inloggen.",
    "settings.password_error_invalid": "✗ Controleer gebruikersnaam en wachtwoord. De gebruikersnaam is 3–64 tekens zonder spaties; het wachtwoord heeft minimaal 12 tekens.",
    "settings.password_error_mismatch": "✗ De wachtwoorden zijn niet gelijk.",
    "settings.password_last_method": "✗ Je kunt de laatste beschikbare inlogmethode niet verwijderen.",
    ...
    "settings.restore_hint": "Alleen beschikbaar in een lege installatie. Gebruik een databaseback-up van dezelfde appversie. Inloggegevens, gekoppelde API-sleutels en crypto-gegevens worden niet meegenomen.",
    "settings.restore_success": "✓ Database hersteld. De inloggegevens van deze installatie zijn behouden.",
...
EN = {
    ...
    "settings.btn_manage": "Manage",
    "settings.section_password_login": "Username & password",
    "settings.password_intro": "Optional local sign-in method for people who do not use a YubiKey or passkey.",
    "settings.password_add": "Add user",
    "settings.password_change": "Change password",
    "settings.confirm_delete_password_user": "Delete this user? They will no longer be able to sign in with a password.",
    "settings.password_error_invalid": "✗ Check the username and password. The username must be 3–64 characters without spaces; the password needs at least 12 characters.",
    "settings.password_error_mismatch": "✗ The passwords do not match.",
    "settings.password_last_method": "✗ You cannot remove the last available sign-in method.",
    ...
    "settings.restore_hint": "Available only for an empty installation. Use a database backup from the same app version. Login credentials, connected API keys and crypto data are not included.",
    "settings.restore_success": "✓ Database restored. This installation's login credentials were kept.",
